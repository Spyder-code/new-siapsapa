...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('react_posts', function (Blueprint $table) {
            ...
            $table->foreignId('agenda_id')->nullable()->constrained('agenda')->cascadeOnDelete()->cascadeOnUpdate();
            $table->foreignId('react_id')->nullable()->constrained()->cascadeOnDelete()->cascadeOnUpdate();
            $table->timestamps();
        });
    }
