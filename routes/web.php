...
Route::middleware(['auth', 'admin'])->group(function () {
    Route::prefix('admin')->group(function () {
        ...
        Route::post('add-vote/{lomba}', [LombaController::class, 'addVote'])->name('lomba.vote.add');
        Route::post('destroy-vote/{vote}', [LombaController::class, 'destroyVote'])->name('lomba.vote.destroy');
