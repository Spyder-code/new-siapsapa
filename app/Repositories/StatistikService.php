    ...
    public function getAgama()
    {
        ...
        if($this->gudep==null){
            if($id_wilayah=='all'){
                ...
                $kristen = Anggota::where('status',1)->where('agama','Kristen')->count();
                ...
                if ($len==2) {
                    ...
                    $kristen = Anggota::where('provinsi',$id_wilayah)->where('status',1)->where('agama','Kristen')->count();
                    ...
                    $kristen = Anggota::where('kabupaten',$id_wilayah)->where('status',1)->where('agama','Kristen')->count();
                    ...
                    $kristen = Anggota::where('kecamatan',$id_wilayah)->where('status',1)->where('agama','Kristen')->count();
            ...
            $kristen = Anggota::where('gudep',$this->gudep)->where('status',1)->where('agama','Kristen')->count();
