    ...
    return (function(t) {
        ...
        function(t, e, n) {
            ...
            function k(t, n) {
                var r, i, o;
                for (
                    r = 0; r < e.unitsDesc.length &&
                    ((i = e.unitsDesc[r]), !((o = V(i, t, n)) >= 1 && ut(o))); r++
                );
                return i;
            }
                    ...
                    return (
                        ...
                        (e.prototype.applyManualStandardProps = function(t) {
                            return (
                                ...
                                (this.className = t.className.split(/\s+/)), !0
                            );
                        }),
                        (e.uuid = 0),
                        ...
                        (t.parse = function(e, n) {
                            ...
                            return (!!s.isValid() &&
                                (null == l &&
                                    ...
                                    (l = o.opt("allDayDefault")), !0 === l ?
                                    (s.stripTime(), a && a.stripTime()) :
                                    !1 === l &&
                                    (s.hasTime() || s.time(0), a && !a.hasTime() && a.time(0)), !a || (a.isValid() && a.isAfter(s)) || (a = null), !a && u && (a = o.getDefaultEventEnd(!s.hasTime(), s)),
                                    new t(s, a, o))
                            );
                        }),
                    ...
                    return (
                        ...
                        (t.prototype.applyManualStandardProps = function(e) {
                            return (
                                ...
                                (this.className = e.className.split(/\s+/)), !0
                            );
                        }),
                    ...
                    return (
                        ...
                        (t.prototype.buildNewDateProfile = function(t, e) {
                            ...
                            return (
                                ...
                                o && ((n = e.applyTimezone(n)), r && (r = e.applyTimezone(r))), !r &&
                ...
                l = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.canStartDrag = function(t, e) {
                            return (!this.canStartResize(t, e) &&
                                this.isEventDefDraggable(t.footprint.eventDef)
                            );
                        }),
                        ...
                        (e.prototype.isEventInstanceGroupAllowed = function(t) {
                            ...
                            for (e = 0; e < i.length; e++)
                                if (!r.validUnzonedRange.containsRange(
                        ...
                        (e.prototype.isExternalInstanceGroupAllowed = function(t) {
                            ...
                            for (e = 0; e < i.length; e++)
                                if (!r.validUnzonedRange.containsRange(
                                    ...
                                    return !1;
                            for (e = 0; e < i.length; e++)
                                if (!n.calendar.constraints.isSelectionFootprintAllowed(
                ...
                p = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.skipHiddenDays = function(t, e, n) {
                            void 0 === e && (e = 1), void 0 === n && (n = !1);
                            for (
                                var r = t.clone(); this.isHiddenDayHash[(r.day() + (n ? e : 0) + 7) % 7];
                        ...
                        (e.prototype.updateDayTable = function() {
                            for (
                                var t,
                                    ...
                                    o = i.calendar,
                                    s = o.msToUtcMoment(
                                        r.dateProfile.renderUnzonedRange.startMs, !0
                                    ),
                                    a = o.msToUtcMoment(
                                        r.dateProfile.renderUnzonedRange.endMs, !0
                                    ),
                                    l = -1,
                                    u = [],
                                    d = []; s.isBefore(a);
                            ...
                            if (this.breakOnWeeks) {
                                for (
                                    e = d[0].day(), t = 1; t < d.length && d[t].day() !== e; t++
                                );
                    ...
                    return (
                        ...
                        (t.prototype.renderEventFootprints = function(t, e, n, r) {
                            var i,
                                ...
                                s = "fc-helper " + (n || "");
                            for (
                                o = this.eventRenderer.renderFgSegEls(o), i = 0; i < o.length; i++
                            )
                                o[i].el.addClass(s);
                            if (null != r)
                ...
                u = (function() {
                    ...
                    return (
                        ...
                        (t.prototype.addEventDef = function(t) {
                            ...
                            for (
                                i.push(t), this.eventDefsByUid[t.uid] = t, e = 0; e < o.length; e++
                            )
                ...
                p = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.addChild = function(t) {
                            return (!this.childrenByUid[t.uid] &&
                        ...
                        (e.prototype.eventFootprintToSegs = function(t) {
                            ...
                            for (
                                e = this.componentFootprintToSegs(t.componentFootprint), n = 0; n < e.length; n++
                            )
                                (r = e[n]),
                    ...
                    return (
                        ...
                        (t.prototype.initialRender = function() {
                            ...
                            e.addClass("fc"),
                                ...
                                this.optionsManager.watch(
                                    "applyingDirClasses", ["?isRTL", "?locale"],
                                    function(t) {
                        ...
                        (t.prototype.bindViewHandlers = function(t) {
                            ...
                            t.watch("titleForCalendar", ["title"], function(n) {
                                ...
                                t.watch(
                                    "dateProfileForCalendar", ["dateProfile"],
                                    function(n) {
                                        t === e.view &&
                        ...
                        (t.prototype.removeEventSources = function(t) {
                            ...
                            if (null == t) this.eventManager.removeAllSources();
                                ...
                                for (
                                    e = r.multiQuerySources(t), r.freeze(), n = 0; n < e.length; n++
                                )
                                    r.removeSource(e[n]);
                                r.thaw();
                            }
                ...
                f = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.updateSize = function(e, n, r) {
                            ...
                            if (
                                (t.prototype.updateSize.call(this, e, n, r),
                                    (this.axisWidth = u.matchCellWidths(this.el.find(".fc-axis"))), !this.timeGrid.colEls)
                            )
                                return void(
                                    n ||
            ...
            (i = {
                renderHeadIntroHtml: function() {
                    var t,
                        ...
                        n = e.calendar,
                        r = n.msToUtcMoment(
                            this.dateProfile.renderUnzonedRange.startMs, !0
                        );
                ...
                c = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.renderFgSegsIntoContainers = function(t, e) {
                            var n, r;
                            for (
                                n = this.timeGrid.groupSegsByCol(t), r = 0; r < this.timeGrid.colCnt; r++
                            )
