                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="table-responsive">
                            <table class="table w-100" id="kegiatan">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                            @if (strtotime(date('Y-m-d H:i'))<strtotime($item->waktu_selesai))
                                                                ...
                                                                @if (Auth::user()->role!='anggota')
                                                                    ...
                                                                    @endif
                                                                    @if ($item->lomba->penilaian=='subjective' && ($agenda->panitia->where('anggota_id',Auth::user()->anggota->id)->first()||Auth::user()->role == 'admin'))
                                ...
                                @if ($agenda->panitia->where('anggota_id',Auth::user()->anggota->id)->first() || Auth::user()->role == 'admin')
                                <tfoot>
                                    <tr>
